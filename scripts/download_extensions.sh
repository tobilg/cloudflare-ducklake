...
curl https://extensions.duckdb.org/v1.3.1/linux_amd64/spatial.duckdb_extension.gz --output $PWD/extensions/spatial.duckdb_extension.gz
...
curl https://extensions.duckdb.org/v1.3.1/linux_amd64/postgres_scanner.duckdb_extension.gz -o $PWD/extensions/postgres_scanner.duckdb_extension.gz
