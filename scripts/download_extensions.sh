...
# Download extensions
curl https://extensions.duckdb.org/v1.4.1/linux_amd64/httpfs.duckdb_extension.gz --output $PWD/extensions/httpfs.duckdb_extension.gz
curl https://extensions.duckdb.org/v1.4.1/linux_amd64/avro.duckdb_extension.gz --output $PWD/extensions/avro.duckdb_extension.gz
